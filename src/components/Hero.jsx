...
const Hero = () => (
  ...
  <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-6`}>
    ...
    <p className={`${styles.paragraph} max-w-[470px] mt-5`}>our team of experts uses s methodology to identify the credit card most likely to fit your needs. We examine annual percentage rates, annual fees.</p>
